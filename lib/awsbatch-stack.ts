...
export class AwsbatchStack extends cdk.Stack {
    constructor(scope: cdk.App, id: string, props?: cdk.StackProps) {
        ...
        // vpc
        const vpc = new ec2.Vpc(this, 'AWSBatchVPC', {
            cidr: "10.0.0.0/24",
            natGateways: 0,
            maxAzs: 3,
            subnetConfiguration: [
        ...
        const LaunchTemplate = new ec2.CfnLaunchTemplate(this, 'LaunchTemplate', {
            launchTemplateName: env + '-awsBatch-launchTemplate',
            launchTemplateData: {
                blockDeviceMappings: [
                    {
        ...
        */
        ...
        // service link role
        const serviceLinkRoles: string[] = settings.serviceLinkRoles
        for (let role of serviceLinkRoles) {
            if (role == "AWSServiceRoleForEC2Spot") {
                new iam.CfnServiceLinkedRole(this, "AWSServiceRoleForEC2Spot", { awsServiceName: "spot.amazonaws.com" }) }
            if (role == "AWSServiceRoleForEC2SpotFleet") {
                new iam.CfnServiceLinkedRole(this, "AWSServiceRoleForEC2SpotFleet", {
